...
var CRUDOperations = /** @class */ (function () {
    function CRUDOperations() {
        ...
        this.readOne = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, res.status(statuscode_1.NOT_FOUND).json({
                                status: statuscode_1.NOT_FOUND,
                                message: 'Not Found'
                            })];
                    case 2:
                        error_2 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log(id);
                        data = req.body;
                        return [4 /*yield*/, models_1.default[this.model].update(__assign({}, data), { where: {
                                    id: id
                                } })];
                    case 1:
                        result = _a.sent();
        ...
        this.getMany = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        res.status(statuscode_1.OK).json({
                            status: statuscode_1.OK,
                            result: result
                        });
                        return [3 /*break*/, 3];
